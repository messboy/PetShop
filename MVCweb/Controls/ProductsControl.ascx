<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductsControl.ascx.cs" Inherits="MVCweb.Controls.ProductsControl" %>
<%@ Register TagPrefix="PetShopControl" Namespace="MVCweb" %>
